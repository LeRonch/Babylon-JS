Arena = function(game) {
    ...
    var materialGround = new BABYLON.StandardMaterial("groundTexture", scene);
        ...
        materialGround.diffuseTexture.uScale = 1;
        materialGround.diffuseTexture.vScale = 2;

    var materialWall = new BABYLON.StandardMaterial("wallTexture", scene);
        materialWall.diffuseTexture = new BABYLON.Texture("assets/images/ground.jpg", scene);
    ...
    var columns = [];
    var numberColumn = 8;
    var sizeArena = 100*boxArena.scaling.x + 90;
